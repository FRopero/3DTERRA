%  function [ rte, minDist, xy] = tsp_ga_ugv_3D(V3)
%  This function computes the TSP problem for the vertices 'V3' given.
%  Inputs:
%    V3(x;y;z) - set of vertices for the TSP computation
%  Outputs:
%    rte       - sorted array with the path of the vertices building the TSP
%    minDist   - distance of the path

function [ rte, minDist] = tsp_ga_ugv_3D(V3)
