...
problem_params = struct('T',[],'R',300,'N',6,'D',1,'Home',[548;600;-1],'Area',-1,'Gp',[]);
...
%  map_file  = input map. Admited formats: .PNG, .IMG ,e.g: DTEED_030808_1535_031230_1535_A01.IMG or mapa_torres.PNG
%  ugv_tsp   = UGV's TSP Genetic Algoritm Parameters
dana_params = struct('n',0,'z',-1,'slope',20,'path_file','ugv_path','map_file',['..' slash '3DMaps' slash 'DTEED_030808_1535_031230_1535_A01.IMG'],'ugv_tsp',ugv_tsp);

% UAV Path Planning Parameters
%  R = farther distance the UAV can travel
%  Z = fixed altitude of the UAV's path
uav_data = struct('R',problem_params.R,'Z',10);
